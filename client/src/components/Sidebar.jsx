...
const Sidebar = () => {
    ...
    const [input, setInput] = useState(""); // string, not boolean
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="relative py-2 group">
                        ...
                        <div className="absolute right-0 mt-2 w-40 bg-gray-800 text-white rounded shadow-lg hidden group-hover:block">
                            <p onClick={() => navigate('/profile')} className="cursor-pointer text-sm px-4 py-2 hover:bg-gray-700">Edit Profile</p>
                            <hr className="my-1 border-gray-600" />
                            <p onClick ={logout} className="cursor-pointer text-sm px-4 py-2 hover:bg-gray-700">Logout</p>
                        </div>
                    </div>
                </div>
